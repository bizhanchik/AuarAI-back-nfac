...
const ClothingItem = ({ item, onViewDetails, onEditItem }) => {
  ...
  return (
    <div 
      className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden group hover:shadow-lg transition-all duration-300 cursor-pointer"
    ...
    >
      ...
      <div className="aspect-w-1 aspect-h-1 bg-gray-100 relative">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-10 transition-all duration-300 flex items-center justify-center pointer-events-none">
          <div className="p-3 bg-white rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 scale-90 group-hover:scale-100">
...
const ClothingGrid = ({ items, onRefresh, onViewDetails, onEditItem }) => {
